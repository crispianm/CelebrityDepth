...
import config
from dataset import FaceDepthDataset
...
def main():
    ...
    val_dataset = FaceDepthDataset(
        config.FACE_VAL_DIR, config.DEPTH_VAL_DIR, transform=transform
    )
    train_dataset = FaceDepthDataset(
        config.FACE_TRAIN_DIR, config.DEPTH_TRAIN_DIR, transform=transform
    )
